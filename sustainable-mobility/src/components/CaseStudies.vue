<template>
  <div>
    ...
    <v-row>
      <v-col cols="12" md="4" @click="show=1,$vuetify.goTo('#case-studies',{offset:-1000})">
        <v-hover>
      ...
      <v-col cols="12" md="4" @click="show=2; $vuetify.goTo('#case-studies',{offset:-1000})">
        <v-hover>
          <template v-slot:default="{ hover }">
      ...
      <v-col cols="12" md="4" @click="show=3; $vuetify.goTo('#case-studies',{offset:-1000})">
        <v-hover>
          <template v-slot:default="{ hover }">
    ...
    <VancouverMap v-if="show==2" />
    <SingaporeMap v-if="show==3" />
  </div>
</template>
