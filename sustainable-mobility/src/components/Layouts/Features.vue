<template>
  <v-card flat :class="color" style="height: 600px">
    ...
    <v-card-text class="display-1" :class="textcolor">{{subheading}}</v-card-text>
          ...
          <v-col>
            <v-row>
              ...
              <v-card flat>
                ...
                <v-card-text class="headline font-weight-light aspects">
                  Scored
                  <span class="display-1 font-weight-light">{{score[1]}}</span> / 100
                </v-card-text>
                <v-card-text class="title font-weight-light aspects">
                  Rank
                  <span class="headline font-weight-light">{{ranking[1]}}</span> / 68 countries
                </v-card-text>
              </v-card>
            </v-row>
          </v-col>
          <v-col>
            <v-row>
              ...
              <v-card flat>
                ...
                <v-card-text class="headline font-weight-light aspects">
                  Scored
                  <span class="display-1 font-weight-light">{{score[2]}}</span> / 100
                </v-card-text>
                <v-card-text class="title font-weight-light aspects">
                  Rank
                  <span class="headline font-weight-light">{{ranking[2]}}</span> / 68 countries
                </v-card-text>
              </v-card>
            </v-row>
          </v-col>
